...
function OwlChat(props) {
    ...
    if(props.active === 1){
        ...
        return (
                ...
                <motion.div style={chatStyle} className="shadow d-flex flex-column"
                ...
                transition = {{duration: 0.3}}>
                    ...
                    {/* TITULO DEL CHAT */}
                    <div className="w-100 p-2 text-white" style={{backgroundColor: "rgb(123, 201, 66)",     borderRadius: "1rem 0rem 0rem 0rem", zIndex: "3000"}}>
